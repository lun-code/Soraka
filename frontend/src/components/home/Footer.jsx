        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-blue-100/70 text-sm leading-relaxed">
              Cuidamos de ti y de los tuyos con la tecnología más avanzada y un
          ...
          <div>
            <Typography className="font-bold mb-6 text-lg uppercase tracking-wider">
              Enlaces
            </Typography>
          ...
          <div>
            ...
            <ul className="space-y-4 text-blue-100/80">
              ...
              <li className="flex items-center gap-3">
                ...
                <span>contacto@clinicavirtual.com</span>
              </li>
              <li className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="flex gap-4 mb-6">
              ...
              <a
                href="#"
                className="p-2 bg-white/10 rounded-full hover:bg-cyan-500 transition-all group"
              >
                <svg
            ...
            <Typography className="text-sm text-blue-100/60 uppercase font-bold">
              Horario de Atención
            </Typography>
