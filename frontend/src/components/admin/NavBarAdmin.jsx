...
import { LayoutDashboard, Users, Stethoscope, BookOpen, CalendarDays, LogOut } from "lucide-react";
...
const navItems = [
  ...
  { name: "Médicos",        path: "/admin/medicos",        icon: <Stethoscope size={18} /> },
  { name: "Especialidades", path: "/admin/especialidades", icon: <BookOpen size={18} /> },
  { name: "Citas",          path: "/admin/citas",          icon: <CalendarDays size={18} /> },
];
        ...
        <div className="flex h-full items-center justify-between text-white">
          ...
          <div className="flex items-center gap-x-1">
            <Button
              ...
              size="lg"
              color="red"
              className="hidden lg:inline-block px-6 py-3 text-gray-200 text-base shadow-xl hover:scale-105 transition-transform"
